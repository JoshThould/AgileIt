...
class StoryCreateView(LoginRequiredMixin, CreateView):
    model = Story
    fields = ['title', 'description', 'status', 'sprint']  # exclude 'owner'
    template_name = 'sprints/story_form.html'
    success_url = reverse_lazy('sprints:story-list')

    def form_valid(self, form):
        form.instance.owner = self.request.user  # auto-assign owner
...
class StoryUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Story
    fields = ['title', 'description', 'status', 'sprint']  # include 'sprint'
    template_name = 'sprints/story_form.html'
    success_url = reverse_lazy('sprints:story-list')
